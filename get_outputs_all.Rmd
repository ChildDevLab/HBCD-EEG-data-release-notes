...
write.csv(FACE_ERP,paste(output_path,"FACE_ERP.csv", sep="")) #Feel free to change the name of the file to however you would prefer it to be named, as a general example we have chosen "FACE_ERP.csv"
